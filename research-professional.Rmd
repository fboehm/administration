...
A1. Using TIMBR to infer allelic series
...
A2. Aim 2 of the F32 (use TIMBR for allelic series inferences)
...
B1. F2 (CC001 by CC042)
  a. How to use QTL in these F2s to find QTL in DO and CC?

C1. RNAseq data processing and analysis
